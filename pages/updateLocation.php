...
$sql = "UPDATE Pending
SET launch_date = '$launch_date', launch_location = '$launch_location'
WHERE satellite_id = '$satellite_id'"; 

//update data in In-Orbit Satellite table

$sqlTwo = "UPDATE Orbit 
SET launch_latitude = '$launch_latitiude', launch_longitude = '$launch_longitude', altitude = '$launch_altitude', inclination = '$launch_inclination'
WHERE"; 
